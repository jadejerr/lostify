      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            // Show file image if available, otherwise Icon
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: item.status.contains("Lost") ? Colors.red.withOpacity(0.1) : Colors.green.withOpacity(0.1),
                ...
                Text(item.brand.isNotEmpty ? item.brand : "No brand", style: const TextStyle(color: Colors.black87, fontWeight: FontWeight.w500)),
                ...
                Row(
                  children: [
                    ...
                    Expanded(child: Text(item.location, style: const TextStyle(color: Colors.grey, fontSize: 12), overflow: TextOverflow.ellipsis)),
